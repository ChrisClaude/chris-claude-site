      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-x-28">
          ...
          <div>
              ...
              <ul>
                <li>
                  ...
                  <p className='flex items-center mr-1'>
                    <span>01/2018</span> <span className='mx-1'>-</span> <span>12/2020</span>{' '}
            ...
            <div className="mb-6">
              <div className="mb-2">
                <h2 className="text-xl font-semibold uppercase">Find me online</h2>
                <div className="bg-gray-800 w-full h-1 rounded-full"></div>
              </div>
              <ul>
                <li className='border-b border-dashed border-gray-600 pb-2 mb-2'>
                  <p><MdLocationPin />Site</p>
                  <a href='https://chrisclaude.com' target='_blank'>chrisclaude.com</a>
                </li>
                <li className='border-b border-dashed border-gray-600 pb-2 mb-2'>
                  <p><MdLocationPin />LinkedIn</p>
                  <a href='https://www.linkedin.com/in/claude-de-tchambila-a720ba143/' target='_blank'>Claude De-Tchambila</a>
                </li>
                <li className='border-b border-dashed border-gray-600 pb-2 mb-2'>
                  <p><MdLocationPin />GitHub</p>
                  <a href='https://github.com/ChrisClaude' target='_blank'>Chris Claude</a>
                </li>
                <li className='border-b border-dashed border-gray-600 pb-2 mb-2'>
                  <p><MdLocationPin />Stack Overflow</p>
                  <a href='https://stackoverflow.com/users/10338096/chris-claude' target='_blank'>Chris Claude</a>
                </li>
              </ul>
            </div>
