...
export const articles: ArticleType[] = [
  {
    ...
    description: 'How to log different types of information and use logging providers available in .NET Core',
  },
  {
    id: "2",
    src: '/Exception_handling_in_ASP_NET Thumbnail.png',
    alt: 'Exception handling in asp.net thumbnail',
    description: 'Best practices on how to handle errors and exceptions in ASP.NET Core',
  },
  {
    id: "3",
