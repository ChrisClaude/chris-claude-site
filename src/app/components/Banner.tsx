...
const Banner = () => (
  <section className="landing-section w-screen flex flex-col items-center h-screen relative pb-20 mb-20 pt-14 sm:pt-20 md:pb-40 md:w-full  md:mb-28 lg:pt-32">
