...
const navItems = [
  ...
  { label: 'My Articles', href: '/publisher/my-articles' },
  { label: 'Bookmarks', href: '/publisher/bookmarks' },
  { label: 'Profile', href: '/publisher/profile' },
];
  ...
  return (
    <aside className="w-64 min-h-screen bg-gray-900 text-gray-100 flex flex-col">
      <div className="px-6 py-5 border-b border-gray-700">
        ...
        <h1 className="mt-3 text-lg font-bold text-white">Publisher Dashboard</h1>
        {userProfile && (
...
const PublisherLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <AuthGuard userType={['Publisher', 'Admin']}>
