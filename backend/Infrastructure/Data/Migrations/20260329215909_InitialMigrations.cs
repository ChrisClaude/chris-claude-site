        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NewsletterSignUps_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NewsletterSignUps_Users_UpdatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Excerpt = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PostId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NewsletterSignUpId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProcessedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    IsSent = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessedNotifications", x => new { x.PostId, x.NewsletterSignUpId });
                    table.ForeignKey(
                        name: "FK_ProcessedNotifications_NewsletterSignUps_NewsletterSignUpId",
                        column: x => x.NewsletterSignUpId,
                        principalTable: "NewsletterSignUps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProcessedNotifications_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsletterSignUps_CreatedBy",
                table: "NewsletterSignUps",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_NewsletterSignUps_UpdatedBy",
                table: "NewsletterSignUps",
                column: "UpdatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessedNotifications_NewsletterSignUpId",
                table: "ProcessedNotifications",
                column: "NewsletterSignUpId");
